...
const plans: Prisma.PlanCreateInput[] = [
  {
    ...
    maxReadings: 1,
    primaryColor: "#FAFAFA", // 非常に淡いグレー（背景と同化）
    secondaryColor: "#F3F4F6", // gray-100: 控えめな境界
    accentColor: "#9CA3AF", // gray-400: 目立たないアクセント
  },
  {
    code: "FREE",
    name: "フリー",
    ...
    maxReadings: 3,
    hasHistory: true,
    primaryColor: "#F0FDF4", // green-50: 爽やかな緑の背景
    secondaryColor: "#86EFAC", // green-300: 柔らかい緑
    accentColor: "#22C55E", // green-500: フレッシュな緑
  },
  {
    code: "STANDARD",
    name: "スタンダード",
  ...
  },
  {
    ...
    secondaryColor: "#E9D5FF", // purple-200
...
async function importSpreads() {
  try {
    ...
    // CSVファイルの読み込み
    const mdPath = path.join(__dirname, "..", "..", "docs", "spreads_data.csv");
