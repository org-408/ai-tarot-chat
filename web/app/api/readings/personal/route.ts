...
※上記のスプレッド一覧にある正確なスプレッド番号とスプレッド名を使用してください
※例えばスプレッド番号が19でスプレッド名が「キャリアパス」なら: {19}: {キャリアパス}
...
\n
【締めくくり】\n
{鑑定の結果を受けて、気になる点や深く掘り下げたいことがあれば遠慮なく質問するよう、${tarotist.name}として温かく一言添えてください}\n
\n` +
          `【制約条件】\n` +
