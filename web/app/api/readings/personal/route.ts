  ...
  try {
    ...
    if (clientMessages.length <= 1) {
      ...
      system =
        ...
        `例: 「仕事運についてですね。それでは、あなたに合ったスプレッドをいくつかご紹介しますね。」\n` +
        `※ 上記の仕事運の例はあくまで例示であり、相談内容に応じた受け止めを作成してください。\n` +
        `※ この受け止めの文は省略不可。必ず【おすすめのスプレッド】の前に含めてください\n\n` +
        `【おすすめのスプレッド】\n` +
        `相談内容に合ったスプレッドを3つ提案し、それぞれの理由を簡潔に説明してください。\n` +
